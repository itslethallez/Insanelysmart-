...
.task-row { border:2px solid var(--line); border-radius:14px; padding:16px; margin:0 0 12px; }
...
.missed-work-block { border-radius:14px; padding:18px; background:#FFF7ED; margin:22px 0; }
